...
const ceoData = {
  ...
  bio: 'With over 15 years of experience in e-commerce tech, Alex founded TechniFuse to bridge the gap between Shopify stores and high-performance native mobile apps. His focus is on delivering revenue-generating solutions through fast UI and smart retargeting.',
  quote: 'A mobile app isn’t just a tool; it’s the most powerful revenue channel for any modern Shopify brand.',
  achievements: [
    'Launched 150+ Shopify mobile apps',
    'Generated $10M+ via push campaigns',
    'E-commerce Tech Leader of 2024',
    'Featured for Innovation in UX',
  ],
  social: {
    linkedin: '#',
